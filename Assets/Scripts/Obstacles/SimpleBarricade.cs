...
public class SimpleBarricade : Obstacle
{
    ...
    public override IEnumerator Spawn(TrackSegment segment, float t)
    {
        ...
        bool isTutorialFirst = Singletons.Get<TrackManager>().isTutorial && Singletons.Get<TrackManager>().firstObstacle && segment == segment.manager.currentSegment;

        if (isTutorialFirst)
            Singletons.Get<TrackManager>().firstObstacle = false;
