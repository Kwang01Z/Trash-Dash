...
{
	public virtual void OnRunStart(GamePlayManager state)
	{

	}

	public virtual void OnRunTick(GamePlayManager state)
	{
	...
	public virtual bool OnRunEnd(GamePlayManager state)
	{
		return true;
	}
}
...
public class LimitedLengthRun : Modifier
{
	...
	public override void OnRunTick(GamePlayManager state)
	{
	...
	public override void OnRunStart(GamePlayManager state)
	{

	}

	public override bool OnRunEnd(GamePlayManager state)
	{
		state.QuitToLoadout();
		return false;
	}
